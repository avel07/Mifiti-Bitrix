...
<div class="container container__nopadding-sm">
    ...
    <?if($arResult['ORIGINAL_PARAMETERS']['TITLE_SECTION']):?>
    <div class="section__title">
        <h2>
            <?=$arResult['ORIGINAL_PARAMETERS']['TITLE_SECTION']?>
        </h2>
    </div>
    <?endif;?>
    <?if($arResult['ORIGINAL_PARAMETERS']['SUBTITLE_SECTION']):?>
    <div class="section__subtitle">
        <p>
            <?=$arResult['ORIGINAL_PARAMETERS']['SUBTITLE_SECTION']?>
        </p>
    </div>
    <?endif;?>
    ...
    <?if($arResult['ORIGINAL_PARAMETERS']['BUTTON'] === 'Y'):?>
    <div class="section__link"><a href="<?=$arResult['ORIGINAL_PARAMETERS']['BUTTON_LINK']?>"
            class="btn hover__effect--black">
            <?=$arResult['ORIGINAL_PARAMETERS']['BUTTON_TEXT']?>
        </a></div>
    <?endif;?>
    <?else:?>
    <?ShowError("Товаров удовлетворяющих условиям нет.");?>
    <?endif;?>
</div>